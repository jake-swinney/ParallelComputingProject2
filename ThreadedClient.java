...
class ClientThread extends Thread
{
    ...
    public ClientThread(int threadNumber, String fileName)
    {
    ...
    public void runClient() throws IOException
    {
        ...
        */
        ...
        if (fileName.endsWith(".txt"))
        {
            ...
            ThreadedClient.writeTextData(threadNumber, fileName, f.length(), avgMsgSize, avgMsgTime, lookupTime);
        ...
        else
        {
            ...
            //Write stuff to CSV file
            ThreadedClient.writeAVData(threadNumber, fileName, data.length, t, bytesPerSec, lookupTime);
...
public class ThreadedClient
{
    ...
    public static synchronized void writeTextData(int threadNumber, String fileName, long fileSize, int avgMsgSize, long avgMsgTime, long lookupTime)
    {
        ...
        try
        {
            ...
            BufferedWriter outCsv = new BufferedWriter(new FileWriter(csv, true));
            outCsv.write(threadNumber + "," + fileName + "," + fileSize + "," + avgMsgSize + "," + avgMsgTime + "," + lookupTime + "\n");
            outCsv.close();
        }
        catch (IOException e)
        {
    ...
    public static synchronized void writeAVData(int threadNumber, String fileName, long fileSize, long time, long bytesPerSec, long lookupTime)
    {
        File csv = new File("data_av.csv");
        try
        {
            ...
            BufferedWriter outCsv = new BufferedWriter(new FileWriter(csv, true));
            outCsv.write(threadNumber + "," + fileName + "," + fileSize + "," + time + "," + bytesPerSec + "," + lookupTime + "\n");
            outCsv.close();
        }
        catch (IOException e)
        {
